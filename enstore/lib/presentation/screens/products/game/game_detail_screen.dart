          ...
          if (fields.length == 2)
            Padding(
              ...
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Expanded(flex: 2, child: _buildField(fields[0])),
                  const SizedBox(width: 16),
                  Expanded(flex: 1, child: _buildField(fields[1])),
                ],
              ),
            )
          else
          ...
          itemBuilder: (context, index) {
            ...
            return GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  color: isSelected
                      ? AppColors.ocean500.withValues(alpha: 0.1)
                      : AppColors.cloud200,
                  ...
                  children: [
                    Container(
                      ...
                      child: Icon(
                        ...
                        color: isSelected ? Colors.white : AppColors.ocean500,
                        size: 24,
                      ),
                    ),
