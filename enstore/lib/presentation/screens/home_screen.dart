...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _fetchData() async {
    ...
    // Fetch Banners
    debugPrint('Fetching banners from: ${ApiClient.baseUrl}${ApiEndpoints.banners}');
    
    utilityService.getBanners()
      .then((response) {
        if (mounted) {
          setState(() {
            if (response.success) {
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: _isLoggedIn 
                        ? null 
                        : const Icon(Icons.person_rounded, color: AppColors.brand500, size: 28),
                    ),
                    ...
                    _isLoggedIn 
                      ...
                      : TextButton(
                          ...
                          style: TextButton.styleFrom(
                            ...
                            backgroundColor: AppColors.ocean500.withValues(alpha:0.1),
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: [AppColors.ocean500.withValues(alpha: 0.6), AppColors.ocean500.withValues(alpha: 0.8)],
                        ...
                        children: [
                          ...
                          _isLoggedIn 
                            ? Container(
                                ...
                                decoration: BoxDecoration(
                                  color: AppColors.smoke200.withValues(alpha: 0.2),
                                  shape: BoxShape.circle,
                                ),
                                child: Icon(
                            ...
                            : Container(
                                ...
                                child: Text(
                                  'Guest',
                                  style: TextStyle(color: AppColors.brand500.withValues(alpha: 0.6), fontSize: 10, fontWeight: FontWeight.bold),
                                ),
                              ),
                        ],
                      ),
                        ...
                        children: [
                          ...
                          Expanded(
                            child: AppButton(
                              ...
                              prefixIcon: _isLoggedIn ? Icons.qr_code_scanner_rounded : Icons.history_rounded,
              ...
              child: Padding(
                ...
                child: Wrap(
                  ...
                  children: [
                    ...
                    _buildServiceItem('Voucher', Icons.confirmation_number_rounded),
                    _buildServiceItem('E-Wallet', Icons.account_balance_wallet_rounded),
  ...
  Widget _buildPromoCard(String title, String subtitle, String imageUrl, {String? link}) {
