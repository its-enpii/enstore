    ...
    utilityService
          ...
          if (mounted) {
            setState(() {
              if (response.success) {
                ...
                AppToast.error(context, 'Banner Error: ${response.message}');
              }
        ...
        .catchError((error) {
          if (mounted) {
            setState(() {
              _isLoadingBanners = false;
              AppToast.error(context, 'Connection Error: $error');
            });
          }
        });
  }
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: _isLoggedIn && _avatar != null
                            ? DecorationImage(
                      ...
                      child: _isLoggedIn && _avatar != null
                          ? null
                          : const Icon(
                  ...
                  children: [
                    ...
                    AppServiceItem(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (_) => const PdamScreen()),
                        );
                      },
                    ),
                    AppServiceItem(
