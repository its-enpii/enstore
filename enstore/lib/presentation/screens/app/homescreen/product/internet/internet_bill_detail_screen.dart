...
class InternetBillDetailScreen extends StatefulWidget {
  final PostpaidInquiryResult inquiryResult;

  const InternetBillDetailScreen({super.key, required this.inquiryResult});

  @override
  State<InternetBillDetailScreen> createState() => _InternetBillDetailScreenState();
}

class _InternetBillDetailScreenState extends State<InternetBillDetailScreen> {
