      ...
      return (
        <div className="flex min-h-[calc(100vh-200px)] flex-col items-center justify-center p-4">
            <div className="w-full max-w-md space-y-8 rounded-3xl bg-white p-8 shadow-xl shadow-brand-500/5 text-center">
                ...
                <h2 className="text-2xl font-bold text-brand-500">All Set!</h2>
            ...
            <div>
               <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="block w-full rounded-2xl border-0 bg-smoke-200 py-4 pl-12 pr-12 text-brand-500 ring-1 ring-inset ring-brand-500/5 placeholder:text-brand-500/40 focus:ring-2 focus:ring-inset focus:ring-ocean-500 sm:text-sm sm:leading-6"
                  ...
                  <button
                    ...
                    className="absolute inset-y-0 right-0 flex items-center pr-4 text-brand-500/40 hover:text-brand-500"
                  >
