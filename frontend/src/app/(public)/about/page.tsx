      ...
      <div className="container mx-auto px-4 lg:px-0">
        ...
        <div className="mx-auto mb-20 max-w-4xl space-y-6 text-center">
          <motion.h1
            ...
            className="text-4xl font-bold text-brand-500/90 md:text-6xl"
          >
        ...
        <div className="mb-20 grid grid-cols-1 gap-8 md:grid-cols-2">
          ...
          >
            <h2 className="mb-4 text-2xl font-bold text-brand-500/90">
              Visi Kami
            </h2>
        ...
        <div className="mb-20 space-y-12">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-brand-500/90">
              Kenapa Memilih Kami?
            </h2>
          </div>
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            {values.map((val, idx) => (
              <motion.div
                ...
                className="group rounded-xl border border-brand-500/5 bg-smoke-200 p-8 text-center transition-all hover:border-ocean-500/20"
              >
                ...
                <h3 className="mb-3 text-xl font-bold text-brand-500/90">
                  {val.title}
                </h3>
        ...
        >
          <div className="space-y-4 text-center md:text-left">
            <h2 className="text-3xl font-bold">Punya Pertanyaan?</h2>
          ...
          <div className="flex flex-col gap-6 sm:flex-row">
            <div className="flex items-center gap-4">
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-smoke-200/10">
                <LocalPostOfficeRounded />
              </div>
              <div>
                <p className="text-[10px] font-bold text-cloud-200/40 uppercase">
                  Email
                </p>
