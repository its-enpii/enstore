...
export default function ForgotPasswordPage() {
  ...
  if (sent) {
    return (
      <div className="flex min-h-[calc(100vh-200px)] flex-col items-center justify-center p-4">
        <div className="w-full max-w-md space-y-8 rounded-3xl bg-white p-8 shadow-xl shadow-brand-500/5 text-center">
            ...
            <h2 className="text-2xl font-bold text-brand-500">Check your mail</h2>
  ...
  return (
    <div className="flex min-h-[calc(100vh-200px)] flex-col items-center justify-center p-4">
      <div className="w-full max-w-md space-y-8 rounded-3xl bg-white p-8 shadow-xl shadow-brand-500/5">
        <div className="text-center">
          <h2 className="text-3xl font-black tracking-tight text-brand-500">
            Forgot Password?
          </h2>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  autoComplete="email"
                  required
                  className="block w-full rounded-2xl border-0 bg-smoke-200 py-4 pl-12 text-brand-500 ring-1 ring-inset ring-brand-500/5 placeholder:text-brand-500/40 focus:ring-2 focus:ring-inset focus:ring-ocean-500 sm:text-sm sm:leading-6 transition-all"
          ...
          <div className="flex flex-col gap-3">
             ...
             <Link href="/login" className="w-full">
                <Button variant="ghost" className="w-full text-brand-500/60 hover:text-brand-500" icon={<ArrowBackRounded />}>
                    Back to Login
                </Button>
             </Link>
          </div>
