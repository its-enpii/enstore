...
class BalanceService
{
    ...
    {
        // TODO: Implement hold mechanism if needed in the future
        return;
    }
    ...
    {
        // Fallback to simple deduct if hold is not implemented in DB
        return $this->deductBalance($user, $amount, $description, $transaction);
    }
